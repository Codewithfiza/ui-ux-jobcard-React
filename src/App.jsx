...
{jobOpenings.map(function(elem, idx){
  return <Card key={idx} company={elem.companyName} post={elem.post} location={elem.location} datePosted={elem.datePosted} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} brandLogo ={elem.brandLogo} />
})}
